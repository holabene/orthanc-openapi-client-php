...
/**
 * PeersIdStorePostRequest Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class PeersIdStorePostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_peers__id__store_post_request';
    ...
    */
     ...
     * Sets compress
     *
     * @param bool|null $compress Whether to compress the DICOM instances using gzip before the actual sending
     *
     * @return self
     */
     ...
     * Sets transcode
     *
     * @param string|null $transcode Transcode to the provided DICOM transfer syntax before the actual sending
     *
     * @return self
     */
