...
/**
 * SeriesIdStatisticsGet200Response Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class SeriesIdStatisticsGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_series__id__statistics_get_200_response';
    ...
    */
     ...
     *
     * @param float|null $count_instances Number of child instances within this series
     *
     * @return self
     */
     ...
     *
     * @param string|null $dicom_disk_size Size on the disk of the DICOM instances associated with the series, expressed in bytes
     *
     * @return self
     */
     ...
     *
     * @param float|null $dicom_disk_size_mb Size on the disk of the DICOM instances associated with the series, expressed in megabytes (MB)
     *
     * @return self
     */
     ...
     *
     * @param string|null $dicom_uncompressed_size Size on the disk of the uncompressed DICOM instances associated with the series, expressed in bytes
     *
     * @return self
     */
     ...
     *
     * @param float|null $dicom_uncompressed_size_mb Size on the disk of the uncompressed DICOM instances associated with the series, expressed in megabytes (MB)
     *
     * @return self
     */
     ...
     * Sets disk_size
     *
     * @param string|null $disk_size Size of the series on the disk in bytes, expressed as a string for 64bit compatibility with JSON
     *
     * @return self
     */
     ...
     * Sets disk_size_mb
     *
     * @param float|null $disk_size_mb Size of the series on the disk, expressed in megabytes (MB)
     *
     * @return self
     */
     ...
     *
     * @param string|null $uncompressed_size Size of the series after decompression in bytes, expressed as a string for 64bit compatibility with JSON
     *
     * @return self
     */
     ...
     *
     * @param float|null $uncompressed_size_mb Size of the series after decompression, expressed in megabytes (MB). This is different from `DiskSizeMB` iff `StorageCompression` is `true`.
     *
     * @return self
     */
