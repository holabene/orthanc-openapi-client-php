...
/**
 * ToolsCreateMediaExtendedPostRequest Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class ToolsCreateMediaExtendedPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tools_create_media_extended_post_request';
    ...
    */
     ...
     * Sets extended
     *
     * @param bool|null $extended If `true`, will include additional tags such as `SeriesDescription`, leading to a so-called *extended DICOMDIR*. Default value is `true`.
     *
     * @return self
     */
